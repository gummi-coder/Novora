...
const Footer = () => {
  return (
    <footer className="bg-novora-950 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company info */}
          <div>
            <Link to="/" className="inline-block mb-6">
              <span className="text-2xl font-bold bg-gradient-to-r from-novora-400 to-teal-500 bg-clip-text text-transparent">
                Novora
              </span>
            </Link>
            <p className="text-gray-300 mb-6">
              Empowering teams to achieve more with our comprehensive suite of tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/auth/signin" className="text-gray-300 hover:text-white transition-colors">
                  Sign In
                </Link>
              </li>
            </ul>
