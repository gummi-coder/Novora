  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="flex items-center justify-between px-6 py-3 h-16">
        {/* Left side: Admin View / My Teams */}
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2">
            <Shield className="w-6 h-6 text-purple-600" />
            <div>
              <h1 className="text-lg font-semibold text-gray-900">Admin View</h1>
              <p className="text-xs text-gray-500">Managing {teams.length} teams</p>
            </div>
          </div>
        </div>
