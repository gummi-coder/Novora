...
import { Building, ChevronLeft, ChevronRight, Home, TrendingUp, MessageSquare, AlertTriangle, BarChart3, FileText, Settings, Users } from 'lucide-react';
...
const AppSidebar = ({ activeSection, onSectionChange, teamsCount = 2 }: AppSidebarProps) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="font-bold text-xl text-gray-900">Novora</span>
                              <div className="text-xs text-gray-600 font-medium">Admin Control Center</div>
            </div>
          </div>
        )}
        <Button
